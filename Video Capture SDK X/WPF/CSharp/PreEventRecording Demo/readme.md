# Pre-Event Recording Demo - VideoCaptureCoreX - WPF
...
- Simple high-level API (VideoCaptureCoreX)
...
- **Media Blocks SDK WPF** - Manual pipeline control with `PreEventRecordingBlock`
- **VideoCaptureCoreX Avalonia** - Cross-platform version (Windows, macOS, Linux)
