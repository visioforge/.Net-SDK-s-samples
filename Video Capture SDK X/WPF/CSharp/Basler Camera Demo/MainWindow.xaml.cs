...
namespace Basler_Camera_Demo
{
    /// <summary>
    /// Interaction logic for the Basler Camera Demo WPF demo's MainWindow.
    /// Demonstrates how to discover and capture from Basler industrial cameras using the X-engine.
    /// </summary>
    public partial class MainWindow : Window
    {
        ...
        /// Configures the engine for the selected Basler camera and starts the preview.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        ...
        private async void btStart_Click(object sender, RoutedEventArgs e)
        {
            ...
            _core.Video_Source = new BaslerSourceSettings(device);
        ...
        /// Initializes the SDK and enumerates available Basler cameras.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="RoutedEventArgs"/> instance containing the event data.</param>
