...
namespace Capture_Object_Detection_X_WPF
{
    /// <summary>
    /// Inserts a YOLO object detector into VideoCaptureCoreX via Video_Processing_AddBlock: it taps the live
    /// camera frames, draws bounding boxes into the preview, and raises OnObjectsDetected.
    /// </summary>
    public partial class MainWindow : Window
    {
        ...
        // Reads the "Min confidence %" field (0-100) as a 0..1 detector threshold; defaults to 0.6 on a bad value.
        ...
        private async void btDownloadModel_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                // Run the network + disk copy off the UI thread so a large model download can't freeze the window.
        ...
        private async void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                // Always re-enable, even if device enumeration failed.
                IsEnabled = true;
            }
        }
