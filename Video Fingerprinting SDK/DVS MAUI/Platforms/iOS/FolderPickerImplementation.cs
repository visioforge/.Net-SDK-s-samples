...
namespace DVS_MAUI.Platforms.iOS;

/// <summary>
/// iOS-specific implementation of the folder picker.
/// </summary>
/// <remarks>
/// iOS folder picker implementation using UIDocumentPickerViewController.
/// Similar to Mac Catalyst but optimized for iOS.
/// </remarks>
public class FolderPickerImplementation : IFolderPicker
{
    /// <summary>
    /// Opens an iOS folder picker dialog using UIDocumentPickerViewController and returns the selected folder path.
    /// </summary>
    ...
    public async Task<string> PickFolderAsync(string title, string initialPath = null)
    {
        ...
        await Microsoft.Maui.Controls.Application.Current.Dispatcher.DispatchAsync(async () =>
        {
            try
            {
                // For iOS, we use UIDocumentPickerViewController with folder selection
