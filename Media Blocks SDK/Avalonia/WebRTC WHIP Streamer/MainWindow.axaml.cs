...
namespace WebRTCWHIPStreamerAMB
{
    public partial class MainWindow : Window, IDisposable
    {
        ...
        private void InitControls()
        {
            ...
            edWHIPEndpoint = this.FindControl<TextBox>("edWHIPEndpoint");
            edAuthToken = this.FindControl<TextBox>("edAuthToken");
            edStunServer = this.FindControl<TextBox>("edStunServer");
        ...
        private async void btStart_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    Location = edWHIPEndpoint.Text
                };

                if (!string.IsNullOrEmpty(edAuthToken.Text))
                {
                    whipSettings.AuthToken = edAuthToken.Text;
                }

                if (!string.IsNullOrEmpty(edStunServer.Text))
                {
                    whipSettings.StunServer = edStunServer.Text;
                }
