...
This cross-platform application captures video and audio from local devices, encodes them to H.264/AAC, and streams over RIST (Reliable Internet Stream Transport) protocol using MPEG-TS.
