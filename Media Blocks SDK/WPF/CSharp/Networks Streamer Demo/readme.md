...
This application captures system audio output, captures desktop/screen content, saves output to MP4 format, outputs HLS streaming segments, streams via NDI network protocol, streams to YouTube Live, streams to Facebook Live, splits video stream for multiple outputs.
